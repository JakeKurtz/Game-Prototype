...
/*if (mouse_check_button(mb_left)) {
	part_emitter_region(obj_ps.part_system, obj_ps.part_emitter, mouse_x-5, mouse_x+5, mouse_y-5, mouse_y+5, ps_shape_rectangle, ps_distr_linear);
	part_emitter_burst(obj_ps.part_system, obj_ps.part_emitter, obj_ps.part_blood, 3);
