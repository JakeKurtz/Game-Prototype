///@description Draws a curve between two points with a given starting angle.
///@function draw_curve
///@arg x1 position of start of curve, real
///@arg y1 position of start of curve, real
///@arg x2 position of end of curve, real
///@arg y2 position of end of curve, real
///@arg direction start angle of the curve, real
///@arg detail number of segments in the curve, real
